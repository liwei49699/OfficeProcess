...
public class WeChatListAdapter extends BaseQuickAdapter<WeChatListResponseBean.DataBean.DatasBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, WeChatListResponseBean.DataBean.DatasBean item) {
