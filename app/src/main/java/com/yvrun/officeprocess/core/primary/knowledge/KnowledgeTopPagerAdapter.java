 ...
 */
public class KonwledgeTopPagerAdapter extends FragmentPagerAdapter {

    private Fragment[] mFragments;
    private String[] mTitles;

    public KonwledgeTopPagerAdapter(@NonNull FragmentManager fm) {
        super(fm);
    }

    public KonwledgeTopPagerAdapter(@NonNull FragmentManager fm, int behavior) {
        super(fm, behavior);
    }
