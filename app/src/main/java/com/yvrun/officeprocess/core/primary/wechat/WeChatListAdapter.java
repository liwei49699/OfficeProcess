...
public class HomeAdapter extends BaseQuickAdapter<ArticleResponseBean.DataBean.DatasBean, BaseViewHolder> {
    ...
    @Override
    protected void convert(BaseViewHolder helper, ArticleResponseBean.DataBean.DatasBean item) {
