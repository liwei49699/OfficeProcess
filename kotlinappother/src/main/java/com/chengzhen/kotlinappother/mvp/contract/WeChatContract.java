...
public class WeChatContract {
    ...
    //处理网络请求
    public static class WeChatModelImp extends BaseModel<ArticleResponseBean> {

        @Inject
        public WeChatModelImp(RetrofitService retrofitService) {
    ...
    //处理业务逻辑
    public static class WeChatPresenterImp extends BasePresenter<IWeChatView, WeChatModelImp> {

        @Inject
        public WeChatPresenterImp(WeChatModelImp model, IWeChatView view) {
            super(model, view);
        }
